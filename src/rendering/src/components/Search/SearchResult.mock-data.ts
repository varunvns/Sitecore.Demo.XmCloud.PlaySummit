export const SearchResultData = {
  SearchResultList: [
    {
      ResultTitle: {
        value: 'Supply Chain Solutions',
      },
      ResultDescription: {
        value:
          'How do DP World’s supply chain solutions benefit business? We are reimagining the future of global trade by uniting our infrastructure and expertise to lower costs and improve sustainability',
      },
      ResultLink: {
        value: 'https://dpworld-xmc.vercel.app/Solutions',
      },
    },
    {
      ResultTitle: {
        value: 'Reconfiguring the Supply Chain',
      },
      ResultDescription: {
        value:
          'chain disruptions, future-proofing the global supply chains is paramount.According to Kathy Wengel, Executive Vice-President, Johnson & Johnson, some of the factors that must steer present global',
      },
      ResultLink: {
        value: 'https://dpworld-xmc.vercel.app/Solutions',
      },
    ...
    {
      ResultTitle: {
        value: 'Gartner Supply Chain Planning Summit',
      },
      ResultDescription: {
        value:
          'Automotive Highly customised supply solutions for the automotive industry. Perishables Scalable, flexible and reliable, our global multimodal supply chain solutions move perishable goods end-to-end',
      },
      ResultLink: {
        value: 'https://dpworld-xmc.vercel.app/Solutions',
      },
    ...
    {
      ResultTitle: {
        value: 'DP World acquires leading US-based supply chain solutions provider',
      },
      ResultDescription: {
        value:
          'syncreon operates across the automotive and technology industriesAcquisition will enable DP World to deliver end-to-end solutions to cargo ownersDP World announces the acquisition of 100 per cent of',
      },
      ResultLink: {
        value: 'https://dpworld-xmc.vercel.app/Solutions',
      },
